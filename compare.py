...
def main():
    ...
    for image_row in image_list:
        try:
            ...
            print('Opps, either the image file not exist, or file path/name in images.csv in wrong, ')
            raise
        ...
        #Only call resize function to make two image same size
        if i1.size != i2.size:
            new_i2 = resize(i1, i2)
    ...
    print('Program finished, check result.csv in Test folder or run "open Test/result.cvs" ')
